...
import { formatDuration, formatNumber, formatPercent } from "@airis/airis-utils";
...
async function main(): Promise<void> {
	...
	if (values.help) {
		console.log(`
airis-stats - AI Usage Statistics Dashboard
...
Examples:
  airis-stats              # Start dashboard server
  airis-stats --json       # Print stats as JSON
  airis-stats --port 8080  # Start on custom port
  airis-stats --sync       # Sync and show summary
`);
		return;
	}
