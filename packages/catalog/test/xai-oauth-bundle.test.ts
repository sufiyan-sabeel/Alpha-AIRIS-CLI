...
import MODELS_JSON from "@airis/airis-catalog/models.json" with { type: "json" };
import { buildXaiOAuthStaticSeed } from "@airis/airis-catalog/provider-models/openai-compat";
