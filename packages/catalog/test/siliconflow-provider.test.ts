...
import { getBundledModelReferenceIndex } from "@airis/airis-catalog/identity/bundled";
import { resolveModelReference } from "@airis/airis-catalog/identity/reference";
import type { ProviderCatalogEntry } from "@airis/airis-catalog/provider-models/descriptor-types";
import {
	CATALOG_PROVIDERS,
	DEFAULT_MODEL_PER_PROVIDER,
	PROVIDER_DESCRIPTORS,
} from "@airis/airis-catalog/provider-models/descriptors";
import {
