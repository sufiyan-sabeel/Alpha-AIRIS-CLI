...
import type { AssistantMessage, ThinkingContent, ToolCall } from "@airis/airis-ai/types";
import { buildModel } from "@airis/airis-catalog/build";
import { xiaomiModelManagerOptions } from "@airis/airis-catalog/provider-models/openai-compat";
