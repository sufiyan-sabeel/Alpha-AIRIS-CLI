 ...
 * link/envelope half of `@airis/airis-coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@airis/airis-wire";
import {
	DEFAULT_RELAY_URL,
...
export { COLLAB_PROTO } from "@airis/airis-wire";
