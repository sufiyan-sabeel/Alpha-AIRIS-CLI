...
```sh
bun add @airis/airis-snapcompact
```
...
```ts
import { renderMany, frames, resolveShape } from "@airis/airis-snapcompact";
...
```ts
import { compact } from "@airis/airis-snapcompact";
