...
import { DEFAULT_TAB_WIDTH } from "@airis/airis-utils";

export { Ellipsis } from "@airis/airis-natives";

export { DEFAULT_TAB_WIDTH } from "@airis/airis-utils";
...
// Wire encoding for the native override (see crates/airis-natives text.rs):
...
// crates/airis-natives/src/text.rs, including the rule that the zero-width filler
