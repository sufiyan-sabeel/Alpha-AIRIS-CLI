...
import { type Component, CURSOR_MARKER, type NativeScrollbackLiveRegion, TUI } from "@airis/airis-tui";
import { VirtualTerminal } from "./virtual-terminal";

// Regression test for https://github.com/sufiyan-sabeel/Alpha-AIRIS-CLI/issues/1974
//
...
/**
 * Minimal append-only live region. Models the real airis setup where
...
describe("issue #1974: tmux scrollback rendering", () => {
	...
	it("does not push chrome below the live block into pane history", async () => {
		// Models a real airis frame: streamed assistant reply on top, persistent
