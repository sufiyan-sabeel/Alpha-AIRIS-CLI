...
import * as gitlabDuoWorkflowOAuth from "@airis/airis-ai/registry/oauth/gitlab-duo-workflow";
import type { OAuthLoginCallbacks, OAuthProviderInterface } from "@airis/airis-ai/registry/oauth/types";
