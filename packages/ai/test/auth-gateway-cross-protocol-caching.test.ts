 ...
 *     → openai-responses parser → airis Context
 *     → airis-ai anthropic provider (auto cache_control via cacheRetention)
...
const MODEL = Bun.env.AIRIS_E2E_ANTHROPIC_MODEL ?? "claude-sonnet-4-5";
