...
import type { AssistantMessage, Message, Model, UserMessage } from "@airis/airis-ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.airis/logs/http-400-requests/*.json` after Claude
