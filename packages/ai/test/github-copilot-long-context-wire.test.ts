...
import type { Api, Context, Model, ModelSpec } from "@airis/airis-ai/types";
import { buildModel } from "@airis/airis-catalog/build";
import { COPILOT_API_HEADERS } from "@airis/airis-catalog/wire/github-copilot";
 ...
 * hint (an alpha-airis-cli extension that preserves native-resolution snapcompact
