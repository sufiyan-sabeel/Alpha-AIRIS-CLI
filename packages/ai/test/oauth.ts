/**
 * Test helper for resolving API keys from ~/.airis/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@airis/airis-ai/oauth";
import type { OAuthCredentials, OAuthProvider } from "@airis/airis-ai/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@airis/airis-utils";
...
/**
 * Resolve API key for a provider from ~/.airis/agent/testauth.db
 *
