...
import type { Api, Context, ImageContent, Model, OptionsForApi, UserMessage } from "@airis/airis-ai/types";
import { getBundledModel } from "@airis/airis-catalog/models";
import { $which, removeSyncWithRetries } from "@airis/airis-utils";
import { e2eApiKey } from "./oauth";

const TEMP_DIR = fs.mkdtempSync(path.join(os.tmpdir(), "airis-temp-images-"));
