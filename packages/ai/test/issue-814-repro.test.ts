...
import type { AssistantMessage, Model, ModelSpec, ToolResultMessage, UserMessage } from "@airis/airis-ai/types";
 ...
 * carries `tool_use_id`. As a workaround, AIRIS must include `id` (aliased to
