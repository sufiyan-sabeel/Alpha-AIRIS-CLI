...
import type { ResponseInput } from "@airis/airis-ai/providers/openai-responses-wire";
import { buildResponsesInput } from "@airis/airis-ai/providers/openai-shared";
import type { AssistantMessage, Context, ToolResultMessage, UserMessage } from "@airis/airis-ai/types";
import { createOpenAIResponsesHistoryPayload } from "@airis/airis-ai/utils";
...
function harmonyPoisonedContext(): { context: Context; user: UserMessage; toolResult: ToolResultMessage } {
	...
	const toolResult: ToolResultMessage = {
		...
		toolName: "grep",
		isError: false,
		content: [{ type: "text", text: `airis://toolconv/harmony.md: ${MARKER}\nmore docs` }],
		timestamp: 0,
	};
