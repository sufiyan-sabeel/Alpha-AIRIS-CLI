...
import type { Model } from "@airis/airis-ai/types";
...
export const AUTH_GATEWAY_E2E_URL = Bun.env.AIRIS_E2E_GATEWAY_URL ?? "http://127.0.0.1:4000";

const AUTH_GATEWAY_TOKEN_PATH = path.join(os.homedir(), ".airis", "auth-gateway.token");
