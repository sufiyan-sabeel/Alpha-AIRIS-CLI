...
import { bareModelId, parseAnthropicModel } from "@airis/airis-catalog/identity";
import { toNumber } from "@airis/airis-catalog/utils";
 ...
 * at 5% with a live reset rendered as `not reported` in `airis usage`.
 */
