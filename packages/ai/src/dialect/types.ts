import type { Dialect as CatalogDialect } from "@airis/airis-catalog/identity";
import type { Context, Message, ToolCall } from "../types";

export type { Dialect } from "@airis/airis-catalog/identity";
...
export interface InbandScannerOptions {
	...
	/** Full tool schemas for schema-driven dialects such as GLM XML and airis-native. */
