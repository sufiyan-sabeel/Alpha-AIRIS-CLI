...
/** AIRIS's own key name so sign-in never mutates ZCode's `zcode-api-key`. */
const KEY_NAME = "alpha-airis-cli";
 ...
 * `getCustomerInfo` → find/create the AIRIS-named key → obtain its secret →
