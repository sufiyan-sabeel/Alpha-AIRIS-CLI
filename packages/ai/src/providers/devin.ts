...
} from "@airis/airis-catalog/discovery/devin-gen/exa/api_server_pb/api_server_pb";
import {
	GetUserJwtRequestSchema,
	GetUserJwtResponseSchema,
} from "@airis/airis-catalog/discovery/devin-gen/exa/auth_pb/auth_pb";
import {
	CacheControlType,
...
} from "@airis/airis-catalog/discovery/devin-gen/exa/chat_pb/chat_pb";
import {
	ChatMessageSource,
	type ChatToolCall,
	ChatToolCallSchema,
	...
	MetadataSchema,
	StopReason,
} from "@airis/airis-catalog/discovery/devin-gen/exa/codeium_common_pb/codeium_common_pb";
import { calculateCost } from "@airis/airis-catalog/models";
import { logger, parseStreamingJson, parseStreamingJsonThrottled } from "@airis/airis-utils";
...
/** Map airis `Message` history onto Cascade `ChatMessagePrompt`s (USER / SYSTEM / TOOL channels). */
