 ...
 * gateway. Maps canonical wire variants to our internal normalized airis Context
 * and options.
 */
...
// `cache_control` is accepted and translated to airis-ai's per-request
...
// preserve per-block breakpoints — airis-ai's anthropic provider re-applies them
