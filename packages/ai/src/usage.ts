 ...
 * when banked resets expire ([#3339](https://github.com/sufiyan-sabeel/Alpha-AIRIS-CLI/issues/3339)).
 */
...
export interface UsageReport {
	 ...
	 * Use this for caveats that apply to every limit (e.g. "AIRIS-observed
