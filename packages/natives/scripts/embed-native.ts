...
const candidates: CandidateAddon[] =
	targetArch === "x64"
		? [
				{ variant: "modern", filename: `airis_natives.${platformTag}-modern.node` },
				{ variant: "baseline", filename: `airis_natives.${platformTag}-baseline.node` },
			]
		: [{ variant: "default", filename: `airis_natives.${platformTag}.node` }];
