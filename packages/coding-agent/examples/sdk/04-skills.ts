 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@airis/airis-coding-agent";

// Discover all skills from cwd/.airis/skills, ~/.airis/agent/skills, etc.
