...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@airis/airis-coding-agent/session/messages";
import type { CustomMessageEntry } from "@airis/airis-coding-agent/session/session-entries";
