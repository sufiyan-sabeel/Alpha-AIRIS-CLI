...
import { renderSearchResult, type SearchRenderDetails } from "@airis/airis-coding-agent/web/search/render";
import type { SearchResponse } from "@airis/airis-coding-agent/web/search/types";
