...
import { BUILTIN_TOOL_NAMES } from "@airis/airis-coding-agent/tools/builtin-names";

// Every shipped built-in tool that is exposed to the model in normal sessions
// must have a docs/tools/<name>.md root doc served by `airis://`. File names use
...
describe("airis:// root docs coverage", () => {
