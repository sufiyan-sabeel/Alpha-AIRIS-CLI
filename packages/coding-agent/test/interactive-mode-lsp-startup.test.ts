...
import { LSP_STARTUP_EVENT_CHANNEL, type LspStartupEvent } from "@airis/airis-coding-agent/lsp/startup-events";
...
import type { LspStartupServerInfo } from "@airis/airis-coding-agent/tools";
...
describe("InteractiveMode LSP startup welcome banner", () => {
	...
	beforeEach(async () => {
		...
		tempDir = TempDir.createSync("@airs-interactive-mode-lsp-startup-");
