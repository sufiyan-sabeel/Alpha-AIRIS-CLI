...
import { handleArtifactHub } from "@airis/airis-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@airis/airis-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@airis/airis-coding-agent/web/scrapers/discogs";
