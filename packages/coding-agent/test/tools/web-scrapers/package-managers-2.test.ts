...
import { handleChocolatey } from "@airis/airis-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@airis/airis-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@airis/airis-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@airis/airis-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@airis/airis-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@airis/airis-coding-agent/web/scrapers/terraform";
