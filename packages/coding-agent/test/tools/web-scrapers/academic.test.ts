...
import { handleArxiv } from "@airis/airis-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@airis/airis-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@airis/airis-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@airis/airis-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@airis/airis-coding-agent/web/scrapers/types";
