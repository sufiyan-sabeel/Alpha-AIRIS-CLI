...
import { handleCheatSh } from "@airis/airis-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@airis/airis-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@airis/airis-coding-agent/web/scrapers/tldr";
