...
import { handleHuggingFace } from "@airis/airis-coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@airis/airis-coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@airis/airis-coding-agent/web/scrapers/vimeo";
