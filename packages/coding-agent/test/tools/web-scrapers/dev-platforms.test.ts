...
import { handleDevTo } from "@airis/airis-coding-agent/web/scrapers/devto";
import { handleGitLab } from "@airis/airis-coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@airis/airis-coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@airis/airis-coding-agent/web/scrapers/lobsters";
