...
import { handleBiorxiv } from "@airis/airis-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@airis/airis-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@airis/airis-coding-agent/web/scrapers/wikidata";
