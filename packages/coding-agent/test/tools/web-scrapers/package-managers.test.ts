...
import { handleAur } from "@airis/airis-coding-agent/web/scrapers/aur";
import { handleBrew } from "@airis/airis-coding-agent/web/scrapers/brew";
import { handleMaven } from "@airis/airis-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@airis/airis-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@airis/airis-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@airis/airis-coding-agent/web/scrapers/rubygems";
