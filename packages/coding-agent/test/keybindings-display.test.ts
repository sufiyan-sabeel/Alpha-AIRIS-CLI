...
import { getDefaultPasteImageKeys, KeybindingsManager } from "@airis/airis-coding-agent/config/keybindings";
import { keyText } from "@airis/airis-coding-agent/extensibility/legacy-airis-coding-agent-shim";
