...
import { renderWelcomeTip } from "@airis/airis-coding-agent/modes/components/welcome";
import { initTheme, setTheme, theme } from "@airis/airis-coding-agent/modes/theme/theme";
