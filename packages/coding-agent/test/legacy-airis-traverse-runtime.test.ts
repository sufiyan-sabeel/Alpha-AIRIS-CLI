...
const probePath = path.resolve(import.meta.dir, "fixtures", "legacy-airis-babel-cache-probe.ts");
const positiveControlPath = path.resolve(import.meta.dir, "fixtures", "legacy-airis-babel-cache-positive-control.ts");
