...
import type { ToolExecutionComponent } from "@airis/airis-coding-agent/modes/components/tool-execution";
...
import type { TaskToolDetails } from "@airis/airis-coding-agent/task/types";
import type { BashToolDetails } from "@airis/airis-coding-agent/tools/bash";
