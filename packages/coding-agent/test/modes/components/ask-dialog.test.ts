...
import type { ExtensionAskDialogQuestion } from "@airis/airis-coding-agent/extensibility/extensions/types";
import { AskDialogComponent } from "@airis/airis-coding-agent/modes/components/ask-dialog";
