...
import { PluginSelectorComponent } from "@airis/airis-coding-agent/modes/components/plugin-selector";
import { QueueModeSelectorComponent } from "@airis/airis-coding-agent/modes/components/queue-mode-selector";
import { ThemeSelectorComponent } from "@airis/airis-coding-agent/modes/components/theme-selector";
import { ThinkingSelectorComponent } from "@airis/airis-coding-agent/modes/components/thinking-selector";
import { initTheme } from "@airis/airis-coding-agent/modes/theme/theme";
import type { SgrMouseEvent } from "@airis/airis-tui";
