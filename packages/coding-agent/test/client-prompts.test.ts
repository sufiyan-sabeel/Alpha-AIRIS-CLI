...
import { getPrompt, listPrompts, serverSupportsPrompts } from "@airis/airis-coding-agent/mcp/client";
import type { MCPGetPromptResult, MCPPrompt, MCPPromptsListResult } from "@airis/airis-coding-agent/mcp/types";
