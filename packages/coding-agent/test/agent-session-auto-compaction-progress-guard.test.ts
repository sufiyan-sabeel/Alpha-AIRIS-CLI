...
import { resolveThresholdTokens, shouldCompact } from "@airis/airis-agent-core/compaction";
...
import type { CompactionEntry } from "@airis/airis-coding-agent/session/session-entries";
...
describe("AgentSession auto-compaction progress guard", () => {
	...
	beforeEach(async () => {
		tempDir = TempDir.createSync("@airs-auto-compaction-progress-");
