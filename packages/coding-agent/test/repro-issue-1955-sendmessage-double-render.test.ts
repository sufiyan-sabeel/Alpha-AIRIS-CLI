...
import { ExtensionUiController } from "@airis/airis-coding-agent/modes/controllers/extension-ui-controller";
...
import { buildSessionContext, type SessionContext } from "@airis/airis-coding-agent/session/session-context";
import type { CustomMessageEntry, SessionEntry } from "@airis/airis-coding-agent/session/session-entries";
