...
import type { AgentToolCall } from "@airis/airis-agent-core";
import type { SessionMessageEntry } from "@airis/airis-agent-core/compaction/entries";
import { DEFAULT_PRUNE_CONFIG, pruneToolOutputs } from "@airis/airis-agent-core/compaction/pruning";
import { AGGRESSIVE_SHAKE_CONFIG, collectShakeRegions } from "@airis/airis-agent-core/compaction/shake";
import type { ProtectedToolContext } from "@airis/airis-agent-core/compaction/tool-protection";
import type { AssistantMessage, TextContent, ToolResultMessage, Usage } from "@airis/airis-ai";
import { createPlanReadMatcher } from "@airis/airis-coding-agent/plan-mode/plan-protection";
