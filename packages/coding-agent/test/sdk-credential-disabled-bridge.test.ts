...
import { AuthStorage, type CredentialDisabledEvent } from "@airis/airis-ai";
import * as oauthUtils from "@airis/airis-ai/oauth";
import { ModelRegistry } from "@airis/airis-coding-agent/config/model-registry";
import { Settings } from "@airis/airis-coding-agent/config/settings";
import type { Extension, ExtensionError, ExtensionFactory } from "@airis/airis-coding-agent/extensibility/extensions";
import { ExtensionRunner } from "@airis/airis-coding-agent/extensibility/extensions";
import { ExtensionRuntime } from "@airis/airis-coding-agent/extensibility/extensions/loader";
...
describe("createAgentSession credential_disabled subscription", () => {
	...
	const baseOptions = (dirs: SessionDirs, authStorage: AuthStorage, extensions: ExtensionFactory[] = []) => ({
		...
		// loads the developer's real ~/.airis models config on every construction (~100ms each,
