...
import { applyDisabledExtensionsToState } from "@airis/airis-coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@airis/airis-coding-agent/modes/components/extensions/types";
