...
import { loadCapability, setDisabledProviders } from "@airis/airis-coding-agent/capability";
import type { ContextFile } from "@airis/airis-coding-agent/capability/context-file";
import { clearCache } from "@airis/airis-coding-agent/capability/fs";
import type { Instruction } from "@airis/airis-coding-agent/capability/instruction";
import type { Prompt } from "@airis/airis-coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@airis/airis-coding-agent/capability/rule";
import { RuleProtocolHandler } from "@airis/airis-coding-agent/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@airis/airis-utils";
import "@airis/airis-coding-agent/capability/context-file";
import "@airis/airis-coding-agent/capability/instruction";
import "@airis/airis-coding-agent/capability/prompt";
import "@airis/airis-coding-agent/capability/rule";
