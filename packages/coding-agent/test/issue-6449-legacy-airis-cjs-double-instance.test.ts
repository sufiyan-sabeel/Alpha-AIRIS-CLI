...
import { ensureGraphCommonJsRequireRegistered } from "@airis/airis-coding-agent/extensibility/plugins/legacy-airis-compat";
...
describe("issue #6449: legacy pi CommonJS graph registration is first-wins", () => {
	...
	// so an extension import evaluates a SECOND instance of legacy-airis-compat with
