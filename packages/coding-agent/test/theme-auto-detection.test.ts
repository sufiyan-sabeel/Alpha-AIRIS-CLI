...
import * as nativesModule from "@airis/airis-natives";
import { type MacAppearanceObserver, MacOSAppearance } from "@airis/airis-natives";
import type { Terminal, TerminalAppearance } from "@airis/airis-tui";
