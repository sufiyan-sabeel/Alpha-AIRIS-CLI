...
import { completionBudgetReport, GoalRuntime } from "@airis/airis-coding-agent/goals/runtime";
import type { Goal, GoalModeState, GoalTokenUsage } from "@airis/airis-coding-agent/goals/state";
