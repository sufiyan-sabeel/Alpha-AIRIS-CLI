...
import { applyExtensionFlags, type ExtensionFlagSink } from "@airis/airis-coding-agent/cli/extension-flags";
import { buildInitialMessage } from "@airis/airis-coding-agent/cli/initial-message";
...
import { normalizeContinueSessionArgs } from "@airis/airis-coding-agent/main";
