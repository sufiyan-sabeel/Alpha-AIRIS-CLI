...
import { ExtensionList } from "@airis/airis-coding-agent/modes/components/extensions/extension-list";
import type { Extension } from "@airis/airis-coding-agent/modes/components/extensions/types";
import { HistorySearchComponent } from "@airis/airis-coding-agent/modes/components/history-search";
import { SessionSelectorComponent } from "@airis/airis-coding-agent/modes/components/session-selector";
import { TreeSelectorComponent } from "@airis/airis-coding-agent/modes/components/tree-selector";
import { UserMessageSelectorComponent } from "@airis/airis-coding-agent/modes/components/user-message-selector";
...
import type { SessionTreeNode } from "@airis/airis-coding-agent/session/session-entries";
...
async function createHistoryStorage(prompts: string[]): Promise<HistoryStorage> {
	const dir = TempDir.createSync("@airis-history-nav-");
	tempDirs.push(dir);
	HistoryStorage.resetInstance();
