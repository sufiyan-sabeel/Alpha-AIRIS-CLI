...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@airis/airis-coding-agent/capability/rule";
import { bucketRules } from "@airis/airis-coding-agent/capability/rule-buckets";
