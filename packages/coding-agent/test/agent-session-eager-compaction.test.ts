...
import type { Model, TextContent } from "@airis/airis-ai";
import * as codexResponses from "@airis/airis-ai/providers/openai-codex-responses";
...
import { TodoTool, type ToolSession, USER_TODO_EDIT_CUSTOM_TYPE } from "@airis/airis-coding-agent/tools";
...
describe("AgentSession eager prelude re-injection after compaction", () => {
	...
	beforeEach(() => {
		tempDir = TempDir.createSync("@airs-agent-session-eager-compaction-");
		cleanups.length = 0;
	});
