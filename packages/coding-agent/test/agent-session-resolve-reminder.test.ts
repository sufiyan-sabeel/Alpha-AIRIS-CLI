...
import { Agent, isSoftToolRequirement } from "@airis/airis-agent-core";
...
import { dispatchResolutionDevice, queueResolveHandler } from "@airis/airis-coding-agent/tools/resolve";
import { buildNamedToolChoice } from "@airis/airis-coding-agent/utils/tool-choice";
