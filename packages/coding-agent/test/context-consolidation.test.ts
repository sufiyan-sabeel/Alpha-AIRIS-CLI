...
import { estimateTokens } from "@airis/airis-agent-core/compaction/compaction";
import type { AssistantMessage, Message, Model } from "@airis/airis-ai";
...
import { computeContextBreakdown } from "@airis/airis-coding-agent/modes/utils/context-usage";
...
describe("Context usage consolidation", () => {
	...
	beforeAll(async () => {
		sharedDir = TempDir.createSync("@airs-context-shared-");
