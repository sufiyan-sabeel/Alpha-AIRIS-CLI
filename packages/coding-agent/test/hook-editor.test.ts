...
import { HookEditorComponent } from "@airis/airis-coding-agent/modes/components/hook-editor";
...
import { CURSOR_MARKER, isFocusable, setKeybindings, type TUI } from "@airis/airis-tui";
