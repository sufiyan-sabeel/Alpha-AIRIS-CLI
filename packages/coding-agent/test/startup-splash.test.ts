...
import { runStartupSplash } from "@airis/airis-coding-agent/modes/setup-wizard/startup-splash";
...
import { shouldShowStartupSplash } from "@airis/airis-coding-agent/startup-splash";
