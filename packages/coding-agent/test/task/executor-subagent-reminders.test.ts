...
import { AgentBusyError, type AgentTelemetryConfig, type Tracer } from "@airis/airis-agent-core";
import { type AssistantMessage, Effort } from "@airis/airis-ai";
import { Settings } from "@airis/airis-coding-agent/config/settings";
import type { ExtensionActions, LoadExtensionsResult } from "@airis/airis-coding-agent/extensibility/extensions/types";
...
import type { AuthStorage } from "@airis/airis-coding-agent/session/auth-storage";
import {
	finalizeSubprocessOutput,
	runSubprocess,
	SUBAGENT_WARNING_MISSING_YIELD,
} from "@airis/airis-coding-agent/task/executor";
...
describe("runSubprocess yield reminders", () => {
	...
	const baseOptions = {
		...
		modelRegistry: {
			refresh: async () => {},
		} as unknown as import("@airis/airis-coding-agent/config/model-registry").ModelRegistry,
		enableLsp: false,
	};
