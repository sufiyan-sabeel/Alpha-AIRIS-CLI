...
import { DEFAULT_FUZZY_THRESHOLD, executePatchSingle } from "@airis/airis-coding-agent/edit";
import type { FileDiagnosticsResult } from "@airis/airis-coding-agent/lsp";
...
beforeEach(async () => {
	...
	tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "airis-patch-unchanged-"));
