/**
 * Internal URL router for internal protocols (`agent://`, `artifact://`, `history://`, `issue://`, `local://`, `mcp://`, `memory://`, `airis://`, `pr://`, `rule://`, `security://`, `skill://`, `ssh://`, `vault://`, and `xd://`).
 *
...
import { OmpProtocolHandler } from "./airis-protocol";
...
export class InternalUrlRouter {
	...
	constructor() {
		...
		// Reserved AIRIS-owned security-analysis namespace; vendor adapters normalize into its store.
