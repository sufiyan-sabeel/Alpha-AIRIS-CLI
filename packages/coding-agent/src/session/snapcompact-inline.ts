...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@airis/airis-ai";
...
// Per-provider image-count budgets live in @airis/airis-snapcompact
