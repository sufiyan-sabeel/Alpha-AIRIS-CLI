...
} from "@airis/airis-agent-core/compaction/pruning";
import type { ProtectedToolMatcher } from "@airis/airis-agent-core/compaction/tool-protection";
import type { AssistantMessage, CodexCompactionContext, Message, Model, ProviderSessionState } from "@airis/airis-ai";
