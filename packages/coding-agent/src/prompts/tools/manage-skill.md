Create, update, or delete a managed skill — a `SKILL.md` written to an isolated directory (`~/.airis/agent/managed-skills`) and surfaced like a normal skill in future sessions.
