...
export const DAEMON_BROKER_WORKER_ARG = "__airis_worker_daemon_broker";
...
export const DAEMON_PROJECT_DIR_ENV = "AIRIS_DAEMON_PROJECT_DIR";

/** Environment key carrying the broker's private runtime directory. */
export const DAEMON_RUNTIME_DIR_ENV = "AIRIS_DAEMON_RUNTIME_DIR";

/** Optional environment key overriding last-client shutdown grace. */
export const DAEMON_IDLE_GRACE_ENV = "AIRIS_DAEMON_IDLE_GRACE_MS";
