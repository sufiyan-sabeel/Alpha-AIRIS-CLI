 ...
 * updated immediately. Internal artifacts ('/Users/theo/.airis/agent/sessions/-Projects-alpha-airis-cli/2026-06-10T09-11-41-506Z_019eb0cd-3ec2-7000-92aa-1b82aa4d78f0/local' plan files, other scheme
 * URLs) are always written directly to disk — those are AIRIS-owned and should
 ...
 *
 * Returns `false` for internal-URL paths (e.g. `'/Users/theo/.airis/agent/sessions/-Projects-alpha-airis-cli/2026-06-10T09-11-41-506Z_019eb0cd-3ec2-7000-92aa-1b82aa4d78f0/local/PLAN.md'`) and for the
 * active plan file while plan mode is enabled — both are AIRIS-internal artifacts
...
export function shouldRouteWriteThroughBridge(
	...
	// AIRIS-owned session artifacts (plan files, scratch notes) must stay off the
