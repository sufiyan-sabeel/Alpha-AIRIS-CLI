import { getPuppeteerDir, logger, postmortem, Snowflake, withTimeout, workerHostEntry } from "@airis/airis-utils";
...
async function spawnTabWorker(): Promise<WorkerHandle> {
	try {
		...
		const worker = hostEntry
			? new Worker(hostEntry, { type: "module", argv: ["__airis_worker_tab"] })
