...
const hubSchema = type({
	...
	"persist?": type("boolean").describe("start: survive the last airis client exiting; default false"),
	"detached?": type("boolean").describe(
		"start: survive every airis and broker exit; implies persist and disables PTY input",
	),
