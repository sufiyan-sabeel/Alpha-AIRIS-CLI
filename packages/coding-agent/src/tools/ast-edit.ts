...
import { type AstReplaceChange, type AstReplaceFileChange, astEdit } from "@airis/airis-natives";
import type { Component } from "@airis/airis-tui";
import { replaceTabs, Text } from "@airis/airis-tui";
import { $envpos, prompt, untilAborted } from "@airis/airis-utils";
