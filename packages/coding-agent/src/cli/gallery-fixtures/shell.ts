	...
	eval: {
		...
		result: {
			content: [
				{
					type: "text",
					text: ["@airis/airis-coding-agent v0.42.0", "37 dependencies"].join("\n"),
				},
			],
			details: {
				language: "python",
				languages: ["python"],
				jsonOutputs: [["@ai-sdk/anthropic", "@airis/airis-ai", "@airis/airis-tui"]],
				cells: [
					{
						index: 0,
						title: "load config",
						...
						output: ["@airis/airis-coding-agent v0.42.0", "37 dependencies"].join("\n"),
						status: "complete",
						durationMs: 64,
						exitCode: 0,
					},
