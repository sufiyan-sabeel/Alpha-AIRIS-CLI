 ...
 * `@airis/airis-utils` (or anything that transitively does). That package's
 ...
 * runtime imports from `@airis/airis-utils`, which is the whole reason it can
 ...
 */
export const PROFILE_BOOTSTRAP_BOUNDARY_ARG = "--airis-profile-boundary";
 ...
 * argument — `airis --print --profile work` still selects a profile) apart from an
 ...
 * a flag's value instead of mistaking it for the subcommand — `airis --model acp`
