 ...
 *
 * Handles `airis setup` for onboarding and `airis setup <component>` for optional dependencies.
 */
import * as path from "node:path";
import { $which, APP_NAME, getProjectDir, getPythonEnvDir } from "@airis/airis-utils";
import { $ } from "bun";
...
// package dependencies beyond a working interpreter. `airis setup python --check`
...
/**
 * Unified `airis setup speech` flow. Drives every {@link SpeechComponent} through
