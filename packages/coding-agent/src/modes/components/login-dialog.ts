...
import { Container, getKeybindings, Input, Spacer, Text, type TUI, wrapTextWithAnsi } from "@airis/airis-tui";
...
export class LoginDialogComponent extends Container {
	 ...
	 * SSH/WSL/headless sessions where the AIRIS-hosted `launchUrl` would resolve
