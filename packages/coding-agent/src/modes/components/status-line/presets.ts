...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	default: {
		leftSegments: ["airs", "model", "mode", "collab", "path", "git", "pr", "context_pct", "cost"],
	...
	full: {
		leftSegments: ["airs", "hostname", "model", "mode", "path", "git", "pr", "subagents"],
		rightSegments: [
			"session_name",
			"cache_hit",
			"token_in",
	...
	nerd: {
		...
		leftSegments: ["airs", "hostname", "model", "mode", "path", "git", "pr", "session", "subagents"],
		rightSegments: [
			"session_name",
			"token_in",
			"token_out",
