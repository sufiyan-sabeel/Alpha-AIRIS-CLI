/**
 * Run Alpha AIRIS-CLI as an ACP (Agent Client Protocol) server over stdio.
 *
 ...
 */
import { Command } from "@airis/airis-utils/cli";
...
export default class Acp extends Command {
	static description = "Run Alpha AIRIS-CLI as an ACP (Agent Client Protocol) server over stdio";
	static strict = false;
