/**
 * `airis completions <bash|zsh|fish>` — print a shell completion script.
 *
 ...
 */
import { APP_NAME, VERSION } from "@airis/airis-utils";
import { Args, type CliConfig, Command, type CommandCtor } from "@airis/airis-utils/cli";
