...
It does **not** cover TypeScript/JavaScript extension module loading (`extensions/*.ts`, `index.ts`, `package.json airis.extensions`), which is documented in `extension-loading.md`.
