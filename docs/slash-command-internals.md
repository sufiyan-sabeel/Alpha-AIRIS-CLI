...
2. `airis-plugins` (extension packages) — priority `90`
...
Search roots come from `.airis` directories:

- project: `<cwd>/.airis/commands/*.md`
- user: `~/.airis/agent/commands/*.md`
