...
# terminal transcript.
#
# Prepare a directory (default ~/airis-signing) containing:
...
#   AIRIS_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/airis-signing
...
DIR="${DIR:-${AIRIS_SIGNING_DIR:-$HOME/airis-signing}}"
REPO="${AIRIS_REPO:-sufiyan-sabeel/Alpha-AIRIS-CLI}"
