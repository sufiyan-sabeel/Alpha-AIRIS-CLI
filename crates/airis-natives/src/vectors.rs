//! Batch numeric vector kernels for mnemosyne recall paths.
//!
...
//! `packages/mnemosyne/src/core` exactly — same accumulation order, same
...
/// Cosine similarity with the exact semantics of mnemosyne's TS
