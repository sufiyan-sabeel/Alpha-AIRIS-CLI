...
impl From<airis_ast::summary::SummarySegment> for SummarySegment {
	fn from(value: airis_ast::summary::SummarySegment) -> Self {
		Self {
			kind:       value.kind,
...
impl From<airis_ast::summary::SummaryResult> for SummaryResult {
	fn from(value: airis_ast::summary::SummaryResult) -> Self {
		Self {
...
pub fn summarize_code(options: SummaryOptions) -> Result<SummaryResult> {
	airis_ast::summary::summarize_code(airis_ast::summary::SummaryOptions {
		code:               options.code,
		lang:               options.lang,
		path:               options.path,
