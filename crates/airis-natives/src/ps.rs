...
//!
//! The platform-specific implementation lives in [`airis_shell::process`]; this
...
use airis_shell::process::{self as core_process, ProcessStatus as CoreProcessStatus};
pub use airis_shell::process::{KILL_SIGNAL, TERM_SIGNAL, TerminationTargets, kill_process_group};
