...
//!
//! napi-free by design. `airis-natives` wraps these types in thin `#[napi]`
...
//! # Architecture
//! ```text
//! JS (packages/natives) -> #[napi] adapters (airis-natives audio.rs / live.rs)
//!   -> airis_voice::audio  (miniaudio capture/playback engine)
//!   -> airis_voice::live   (WebRTC peer + Opus media, feeds audio playback)
//! ```
//!
