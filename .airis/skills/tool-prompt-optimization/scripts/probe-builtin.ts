 ...
 *
 * The heavy coding-agent import lives here; probe.ts stays airis-ai-only.
 */
import { parseArgs } from "node:util";
import { toolWireSchema } from "@airis/airis-ai";
import { Settings } from "@airis/airis-coding-agent/config/settings";
import { BUILTIN_TOOLS, GithubTool, HIDDEN_TOOLS, IrcTool, type Tool, type ToolFactory, type ToolSession } from "@airis/airis-coding-agent/tools";
