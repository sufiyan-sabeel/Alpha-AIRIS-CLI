...
// Inline nav glyphs — roboairis has no icon library.
    ...
    <aside class="rmp-rail">
      ...
      <div class="rmp-rail-brand">
        ...
        <span class="rmp-rail-wordmark">
          <span class="rmp-rail-name">roboairis</span>
      ...
      <nav class="rmp-nav">
        {NAV.map((item) => (
          <button
            ...
            title={item.locked ? "Triage — locked (set ROBOAIRIS_REPLAY_TOKEN to enable)" : item.label}
