      ...
      <Show
        ...
        fallback={
          <div class="rmp-trigger-bar">
            ...
            <span class="rmp-trigger-bar-status">set ROBOAIRIS_REPLAY_TOKEN to enable</span>
          </div>
        }
      >
        <div class="rmp-trigger-bar">
      ...
      <Show
        ...
        fallback={
          <div class="px-5 py-7 text-ink-300 text-[13px] leading-relaxed">
            trigger disabled. set <code>ROBOAIRIS_REPLAY_TOKEN</code> in the server env to enable
