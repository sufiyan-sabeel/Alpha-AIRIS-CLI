"""Client half of the roboairis ↔ gh-proxy channel.
...
routing clone/fetch/push through the proxy too — roboairis never holds the PAT.
...
from roboairis.git_ops import GitCommandError, HeadDriftError, PushResult
...
class GitHubProxyClient:
    """HMAC-signed REST client speaking to a `roboairis.proxy.server` instance.
