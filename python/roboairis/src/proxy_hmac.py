"""Shared HMAC signing/verification for the roboairis ↔ gh-proxy channel.

Roboairis signs every request to gh-proxy with an HMAC-SHA256 over
...
# Headers on every roboairis→gh-proxy request.
HEADER_TIMESTAMP = "X-Roboairis-Timestamp"  # unix seconds, integer string
HEADER_SIGNATURE = "X-Roboairis-Sig"  # hex-encoded HMAC-SHA256
