...
from roboairis.worker import DirectiveInfo, ThreadMessage
...
def test_followup_comment_prompt_embeds_thread_context() -> None:
    thread = (
        ThreadMessage(kind="pr_body", author="roboairis", body="PR body", created_at=""),
